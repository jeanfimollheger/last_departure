...
from .views import TaskCreateView, TaskMarkDoneView, TaskUpdateView
...
urlpatterns = [
    ...
    path('tasks/<slug:slug>/done/', TaskMarkDoneView.as_view(), name='task_done'),
    path("tasks/<slug:slug>/edit/", TaskUpdateView.as_view(), name="task_update"),
